...
<?php include 'intro-liens.php'; ?>
    ...
    <div class="container-fluid">
        ...
        <?php include 'nav.php'; ?>
            ...
            <!-- PROJET -->
            <a href="http://melleprunelle.github.io/pastime.github.io/"><img class="img-responsive col-md-8 col-md-offset-2" src="img/img12.png" alt="">
            </a>
            <pre class="col-md-offset-2 col-md-8">
                    <code class="col-md-10 col-md-offset-1 col-xs-10">                    

Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis cupiditate eligendi fugit rerum explicabo nostrum, culpa aperiam similique! Molestiae ex quasi vero dignissimos cupiditate repudiandae debitis, minima tempore natus qui.
