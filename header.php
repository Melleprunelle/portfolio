<header id="startchange" class="container-fluid header">
    ...
    <div class="row">
        <div class="col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-2 col-sm-offset-2 col-sm-2">
               <div>
               <div>
                    <div class="numero animation anim"><i class="fa fa-picture-o fa-5x"></i>
                    </div>
              </div>
             </div>
        ...
        <div class="col-xs-offset-1 col-xs-10  col-md-offset-1 col-md-2 col-sm-offset-1 col-sm-2"> <div>
               <div>
                    <div class="numero animation anim"><i class="fa fa-heart fa-5x"></i>
                    </div>
              </div>
             </div>
        ...
        <div class="col-xs-offset-1 col-xs-10  col-md-offset-1 col-md-2 col-sm-offset-1 col-sm-2"> <div>
               <div>
                    <div class="numero animation anim"><i class="fa fa-comments-o fa-5x"></i>
                    </div>
              </div>
             </div>
