<header id="startchange" class="container-fluid header">
    ...
    <div class="row">
        <div class="col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-2 col-sm-offset-2 col-sm-2"> <i id='animation-header' class="fa fa-heart fa-5x" aria-hidden="true"></i>
        ...
        <div class="col-xs-offset-1 col-xs-10  col-md-offset-1 col-md-2 col-sm-offset-1 col-sm-2"> <i id='animation-header' class="fa fa-paper-plane fa-5x" aria-hidden="true"></i>
        ...
        <div class="col-xs-offset-1 col-xs-10  col-md-offset-1 col-md-2 col-sm-offset-1 col-sm-2"> <i id='animation-header' class="fa fa-comments fa-5x" aria-hidden="true"></i>
